...
/* VOID:INT,INT (../git/vte/src/marshal.list:1) */
...
/* VOID:OBJECT,OBJECT (../git/vte/src/marshal.list:2) */
...
/* VOID:STRING,UINT (../git/vte/src/marshal.list:3) */
...
/* VOID:UINT,UINT (../git/vte/src/marshal.list:4) */
