...
begin_print (GtkPrintOperation *operation,
	     ...
	     gpointer           user_data)
{
  printf ("Entering: begin_print (%p,%p,%p)\n", operation, context, user_data);
...
draw_page (GtkPrintOperation *operation,
	   ...
	   gpointer           user_data)
{
  printf ("Entering: draw_page (%p,%p,%d,%p)\n", operation, context, page_nr, user_data);
  PrintData *data = (PrintData *)user_data;
  cairo_t *cr;
  PangoLayout *layout;
...
end_print (GtkPrintOperation *operation,
	   ...
	   gpointer           user_data)
{
  printf ("Entering: end_print (%p,%p,%p)\n", operation, context, user_data);
  PrintData *data = (PrintData *)user_data;
...
{
  printf ("Entering: do_printing: widget is a %s\n", GTK_OBJECT_TYPE_NAME (do_widget));
  ...
  data->filename = g_strdup ("/home/work/terminal/src/printing.c");
  data->font_size = 12.0;
